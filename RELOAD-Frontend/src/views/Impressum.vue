    ...
    <div class="page-impressum">
        <h1 class="impressum-headline">IMPRESSUM</h1>
            <div class="legal-details">
                ...
                <p><h3>Kontakt:</h3>
                Telefon: +49 157 76818266<br>
                E-Mail: <a href='mailto:info@reload-event.de'>info@reload-event.de</a><br>
                </p>
                <p><h3>Aufsichtsbehörde:</h3>
                Kommunale Finanzaufsicht Düsseldorf<br>
                </p>
                </div>
...
export default {
  ...
  mounted() {
    document.title = 'Impressum | RELOAD'
  }
}
